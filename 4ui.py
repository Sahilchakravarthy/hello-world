...
def analysis():
    ...
    verify_dir = 'E:/SOURCE CODE/test/test'
    IMG_SIZE = 50
    LR = 1e-3
...
def openphoto():
    dirPath = "E:/SOURCE CODE/test/test"
    ...
    fileName = askopenfilename(initialdir='E:/SOURCE CODE/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "E:/SOURCE CODE/test/test"
